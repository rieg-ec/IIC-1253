...
\begin{itemize}
  ...
  \item \textbf{Entrega}: Hasta las 23:59:59 del 19 de octubre a través del buzón habilitado en el sitio del curso (Canvas).
...
\section*{Problemas}
    ...
    \subsection*{Problema 1 - Relaciones de orden}
      \input{P1}

     \subsection*{Problema 2 - Funciones y cardinalidad}
      \input{P2}
